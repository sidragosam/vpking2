...
import com.example.vpking.databinding.AddvizipipaFragmentBinding
...
class VizipipaAddFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = DataBindingUtil.inflate<AddvizipipaFragmentBinding>(inflater, R.layout.addvizipipa_fragment, container, false)
        binding.vpAddThisButton.setOnClickListener { view: View ->
